...
const EUROCODE_ALLOYS = [
  ...
  { id: '3004-H14', name: '3004-H14/H24/H34', maxThickness: 6.13, getProps: (t: number, sectionType: string) => { return { fo: 170, fu: 220, rho_o: 0.42, rho_u: 0.70 }; } },
  { id: '3004-H16', name: '3004-H16/H26/H36', maxThickness: 4.13, getProps: (t: number, sectionType: string) => { return { fo: 190, fu: 240, rho_o: 0.38, rho_u: 0.65 }; } },
  { id: '3005-H14', name: '3005-H14/H24', maxThickness: 6.13, getProps: (t: number, sectionType: string) => { return { fo: 130, fu: 170, rho_o: 0.37, rho_u: 0.68 }; } },
  { id: '3005-H16', name: '3005-H16/H26', maxThickness: 4.13, getProps: (t: number, sectionType: string) => { return { fo: 160, fu: 195, rho_o: 0.32, rho_u: 0.59 }; } },
  { id: '3103-H14', name: '3103-H14/H24', maxThickness: 25, getProps: (t: number, sectionType: string) => { if (t <= 12.5) return { fo: 110, fu: 140, rho_o: 0.40, rho_u: 0.64 }; return { fo: 120, fu: 140, rho_o: 0.37, rho_u: 0.64 }; } },
  { id: '3103-H16', name: '3103-H16/H26', maxThickness: 4, getProps: (t: number, sectionType: string) => { return { fo: 135, fu: 160, rho_o: 0.30, rho_u: 0.56 }; } },
  ...
  { id: '5005-H14', name: '5005/5005A-H14/H24/H34', maxThickness: 12.5, getProps: (t: number, sectionType: string) => { return { fo: 110, fu: 145, rho_o: 0.37, rho_u: 0.69 }; } },
  { id: '5049-O', name: '5049-O/H111', maxThickness: 100, getProps: (t: number, sectionType: string) => { return { fo: 80, fu: 190, rho_o: 1.0, rho_u: 1.0 }; } },
  { id: '5049-H14', name: '5049-H14/H24/H34', maxThickness: 25, getProps: (t: number, sectionType: string) => { return { fo: 160, fu: 240, rho_o: 0.51, rho_u: 0.79 }; } },
  ...
  { id: '5052-H14', name: '5052-H14/H24/H34', maxThickness: 25, getProps: (t: number, sectionType: string) => { return { fo: 150, fu: 230, rho_o: 0.44, rho_u: 0.74 }; } },
  ...
  { id: '5454-H14', name: '5454-H14/H24/H34', maxThickness: 25, getProps: (t: number, sectionType: string) => { return { fo: 200, fu: 270, rho_o: 0.48, rho_u: 0.80 }; } },
  { id: '5754-O', name: '5754-O/H111', maxThickness: 100, getProps: (t: number, sectionType: string) => { return { fo: 80, fu: 190, rho_o: 1.0, rho_u: 1.0 }; } },
  { id: '5754-H14', name: '5754-H14/H24/H34', maxThickness: 25, getProps: (t: number, sectionType: string) => { return { fo: 160, fu: 240, rho_o: 0.53, rho_u: 0.79 }; } },
  ...
  { id: '6061-T4', name: '6061-T4/T451', maxThickness: 12.5, getProps: (t: number, sectionType: string) => { return { fo: 240, fu: 290, rho_o: 0.48, rho_u: 0.60 }; } },
  { id: 'HE30-WP (6061-T6)', name: '6061-T6/T651 (HE30-WP)', maxThickness: 80, getProps: (t: number, sectionType: string) => { if (t <= 12.5) return { fo: 240, fu: 290, rho_o: 0.48, rho_u: 0.60 }; return { fo: 240, fu: 295, rho_o: 0.48, rho_u: 0.60 }; } },
